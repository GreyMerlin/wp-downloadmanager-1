	...
	function download_default_templates(template) {
		...
		switch(template) {
			...
			case "listing":
				...
				break;
			case "embedded":
				default_template = "<p><img src=\"<?php echo plugins_url('wp-downloadmanager/images'); ?>/%FILE_ICON%\" alt=\"\" title=\"\" style=\"vertical-align: middle;\" />&nbsp;&nbsp;<strong><a href=\"%FILE_DOWNLOAD_URL%\">%FILE_NAME%</a></strong> (%FILE_SIZE%<?php _e(',', 'wp-downloadmanager'); ?> %FILE_HITS% <?php _e('hits', 'wp-downloadmanager'); ?>)</p>";
				break;
			case "listing_2":
